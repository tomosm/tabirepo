class Photo < ActiveRecord::Base
  ...
  Proc.new {
    ...
    if Rails.env == 'production'
      {
        # todo s3
        :styles => {:medium => "185x135>", :small => "50x50>"},
        :url  => "/production/photos/:id/:style.:extension",
        :path => ":rails_root/public/production/photos/:id/:style.:extension" 
  ...
  #       # :bucket => 'paperclip.tabirepo.com'
      ...
      {
        :styles => {:medium => "185x135>", :small => "50x50>"},
        :url  => "/development/photos/:id/:style.:extension",
        :path => ":rails_root/public/development/photos/:id/:style.:extension" 
      }
    end
  }.call

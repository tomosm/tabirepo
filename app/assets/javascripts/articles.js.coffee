...
#     </div>'
    paragraphHTML = '<div class="paragraph"><div class="control-group">
      <label for="article_paragraphs_attributes__subtitle" class="control-label">
        <input type="button" class="remove-paragraph" value="-"/>見出し
</label>      <div class="controls">
        <input type="text" value="" size="30" rows="4" placeholder="見出し" name="article[paragraphs_attributes][][subtitle]" id="article_paragraphs_attributes__subtitle" class="span6">  
      </div>
    </div>
    <div class="control-group">
      <label for="article_paragraphs_attributes__sentence" class="control-label">
        ...
        <textarea rows="10" placeholder="文章" name="article[paragraphs_attributes][][sentence]" id="article_paragraphs_attributes__sentence" cols="40" class="span6"></textarea>  
      </div>
    </div></div>'
